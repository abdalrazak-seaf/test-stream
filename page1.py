# -*- coding: utf-8 -*-
"""
Created on Sun Dec 24 19:45:23 2023
...
col1, col2, col3 = st.columns(3)
    ...
    #     fig = px.bar(gender_count, text=gender_count)
    ...
    #     fig = px.bar(nationality_count, text=nationality_count)
    ...
    #     fig = px.bar(branch_count, text=branch_count)
...
with col3:
    ...
    #                  color_continuous_scale='pastel')  # You can change the color_continuous_scale
    ...
    #                  color_continuous_scale='electric')  # You can change the color_continuous_scale
    #     fig.update_traces(texttemplate='%{text}', textposition='outside')
    #     fig.update_layout(xaxis_title="Branch", yaxis_title="Count")
    #     st.plotly_chart(fig, use_container_width=True)
